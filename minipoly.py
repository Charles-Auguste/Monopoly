    ...
    def player_tour(self,player):
        ...
        if b:
            ...
            ## Cas Chance ##
                ...
                self.print_instruction(player,"You're now on a Chance square !", "But you're (un)lucky, such case weren't ", "implemented in the minipoly !!","However, you will lose 10000k€", None)
                player._money -= 10000
