...
class Board:
    def __init__(self):
        ...
        with open("../config/short_properties_name.txt", "r") as tf:
    ...
    def show_board(self, screen,x_init : int, y_init : int, size : int, list_players : list, id_main_player : int) -> int:
        ...
        # Luck and taxe icons
        luck = pygame.image.load('pictures/MINI_MINI_CHANCE.png')
        ...
        taxes = pygame.image.load('pictures/MINI_MINI_TAXE.png')
        ...
        for i in range(1, len(list_players)):
            ...
            if list_players[i].id() == 2:
                ...
                if mini :
                    pion2 = pygame.image.load('pictures/MINI_MINI_PION2.png')
            ...
            if list_players[i].id() == 1:
                ...
                if mini :
                    pion1 = pygame.image.load('pictures/MINI_MINI_PION1.png')
            ...
            if list_players[i].id() == 3:
                ...
                if mini :
                    pion3 = pygame.image.load('pictures/MINI_MINI_PION3.png')
            ...
            if list_players[i].id() == 4:
                ...
                if mini :
                    pion4 = pygame.image.load('pictures/MINI_MINI_PION4.png')
...
class miniBoard(Board):
    def __init__(self):
        ...
        properties = read_properties("../config/mini_properties.txt")
        self._cases = [Case("Start", 0)]
        c = 0
        for i in range(1, 24):
